...
cap = cv2.VideoCapture("/Users/chaitalibhattacharyya/Desktop/쓰리다 어토메이션/two_marker.mp4")
while(True):
    ret, frame = cap.read()
    
    corners, ids, rejectedImgPoints = cv2.aruco.detectMarkers(frame, cv2.aruco.Dictionary_get(cv2.aruco.DICT_5X5_1000))
